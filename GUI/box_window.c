...
int main(int argc, char *argv[])
{
	...
	res_1 = pthread_create(&a_thread_1, NULL, countUp, (void *)top_window_ptr);
	res_2 = pthread_create(&a_thread_2, NULL, countDown, (void *)bottom_window_ptr);
	res_line = pthread_create(&a_thread_line, NULL, middleLine, (void *)middle_window_ptr);
